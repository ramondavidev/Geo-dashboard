...
describe("TimeZoneClock", () => {
  ...
  it("renders user name correctly", () => {
    render(<TimeZoneClock timezone="America/New_York" userName="John Doe" />);
  ...
  it("handles different timezone", () => {
    render(
      <TimeZoneClock timezone="America/Los_Angeles" userName="Jane Smith" />
    );
  ...
  it("cleans up interval on unmount", () => {
    ...
    const { unmount } = render(
      <TimeZoneClock timezone="America/New_York" userName="John Doe" />
    );
