...
describe("WeatherAvatar", () => {
  ...
  it("renders sunny avatar by default", () => {
    render(<WeatherAvatar userName="John Doe" weather={{ ...mockWeatherData, condition: "sunny" }} />);
  ...
  it("handles three names correctly", () => {
    render(<WeatherAvatar userName="John Michael Doe" weather={mockWeatherData} />);
  ...
  it("handles undefined weather condition", () => {
    ...
    render(<WeatherAvatar userName="John Doe" weather={weatherWithoutCondition as WeatherData} />);
    
    expect(screen.getByText("JD")).toBeInTheDocument();
  });

  it("handles different sizes", () => {
    render(<WeatherAvatar userName="John Doe" weather={mockWeatherData} size="lg" />);
