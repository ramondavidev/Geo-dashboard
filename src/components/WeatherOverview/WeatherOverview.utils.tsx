...
export const weatherSvgIcons: Record<string, React.ReactElement> = {
  ...
  rainy: (
    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
      <path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/>
      <path d="M8 19v2M8 13v2M16 19v2M16 13v2M12 21v2M12 15v2" strokeWidth="2" stroke="currentColor" fill="none"/>
    </svg>
  ),
  snowy: (
    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
  ...
  stormy: (
    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
      <path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z"/>
      <path d="M13 16l-3 5 3-3 2-2z" stroke="currentColor" strokeWidth="2" fill="none"/>
    </svg>
  ),
  foggy: (
    <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
...
export const getWeatherIcon = (condition: string, type: "unicode" | "svg" = "unicode") => {
